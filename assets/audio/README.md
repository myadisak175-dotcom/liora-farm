# Liora Farm — Audio Foundation v2

The runtime uses the clean footstep encodes below. Bird and cricket ambience is synthesized by the runtime so it starts reliably and remains audible on mobile speakers.
...
| `ambience_night_crickets_clean.mp3` | `freesound_community-city-night-crickets-24013.mp3` | Retained source/reference; ambience is synthesized in-game |
| `ambience_morning_birds_clean.mp3` | `creative_spark-morning-birdsong-246402.mp3` | Retained source/reference; ambience is synthesized in-game |
